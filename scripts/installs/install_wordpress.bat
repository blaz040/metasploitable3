...
copy C:\king\resources\wordpress\update_ip.ps1 "C:\Program Files\wordpress\update_ip.ps1"
cmd /c ""C:\Program Files\7-Zip\7z.exe" x C:\king\resources\wordpress\wordpress.zip -oC:\wamp\www\"
cmd /c ""C:\wamp\bin\mysql\mysql5.5.20\bin\mysql.exe" -u root --password=""  -e "create database wordpress;""
cmd /c ""C:\wamp\bin\mysql\mysql5.5.20\bin\mysql.exe" -u root --password=""  wordpress < "C:\king\resources\wordpress\wordpress.sql""
